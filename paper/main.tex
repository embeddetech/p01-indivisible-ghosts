...
standard overall sign; $A\mapsto-A$ interchanges the deficiency
indices, and $S_M$ commutes with complex conjugation, so $n_+=n_-$
and the overall sign is immaterial), has deficiency indices
$(2M,2M)$.
\end{theorem}
...
lower-order quadratic terms, not a remainder), each
